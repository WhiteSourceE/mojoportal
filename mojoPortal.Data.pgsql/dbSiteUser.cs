	...
	public static class DBSiteUser
	{
		...
		public static int UserCount(int siteId, string nameBeginsWith, string nameFilterMode)
		{
			List<NpgsqlParameter> arParams = new List<NpgsqlParameter>
			{
				...
				new NpgsqlParameter("namebeginswith", NpgsqlDbType.Varchar, 50)
				{
					Direction = ParameterDirection.Input,
		...
		public static bool PropertyExists(Guid userGuid, string propertyName)
		{
			...
			int count = Convert.ToInt32(NpgsqlHelper.ExecuteScalar(ConnectionString.GetReadConnectionString(),
					CommandType.StoredProcedure,
