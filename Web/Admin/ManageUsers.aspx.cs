...
namespace mojoPortal.Web.AdminUI
{
	public partial class ManageUsers : NonCmsBasePage
	{
		...
		protected string FirstNameSanitized { get; set; }
		protected string LastNameUnsafe { get; set; }
		...
		private void Page_Load(object sender, EventArgs e)
		{
			...
			FirstNameSanitized = txtFirstName.Text;
			LastNameUnsafe = txtLastName.Text;
		}
		...
		private void PopulateControls()
		{
			...
			if ((siteUser != null)&&(siteUser.UserId > -1))
			{
				...
				txtLastName.Text = siteUser.LastName;
