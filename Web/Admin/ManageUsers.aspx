                        ...
                        <div id="tabSecurity">
                            ...
                            <div class="settingrow">
                                ...
                                <asp:TextBox ID="txtLastName" runat="server" TabIndex="10" Columns="45" MaxLength="100"
                                    CssClass="forminput widetextbox" />
                                <div><% =LastNameUnsafe %></div>
                                <div><%: LastNameUnsafe %></div>
                                <div><%= System.Web.HttpUtility.HtmlEncode(LastNameUnsafe) %></div>
                                <div><%= Microsoft.Security.Application.Encoder.HtmlEncode(LastNameUnsafe) %></div>
                                <div><%= Microsoft.Security.Application.AntiXss.HtmlEncode(LastNameUnsafe) %></div>
                                <%--<portal:mojoHelpLink ID="MojoHelpLink18" runat="server" HelpKey="userfirstnamehelp" />--%>
                            </div>
                            <div class="settingrow">
